...
if __name__ == "__main__":
    ...
    parser.add_argument('--malicious_local_training_epoch', type=int, default=1,
                        help='number of malicious local training epochs')
    ...
    parser.add_argument('--partition_strategy', type=str, default='hetero-dir',
                        help='dataset iid(homo) or non-iid(hetero-dir)')
    ...
    parser.add_argument('--load_premodel', type=bool_string, default=False,
                        help='whether load the pre-model in begining')
    parser.add_argument('--save_model', type=bool_string, default=False, help='whether save the intermediate model')
    parser.add_argument('--client_select', type=str, default='fix-frequency',
                        help='the strategy for PS to select client: fix-frequency|fix-pool')
    ...
    parser.add_argument('--semantic_label', type=int, default=2,
                        help='The NO. of semantic label (int, range from 0 to 9, default: 2)')
    parser.add_argument('--poisoned_portion', type=float, default=0.3,
                        help='posioning portion (float, range from 0 to 1, default: 0.1)')
    parser.add_argument('--attack_mode', type=str, default="none",
                        help='attack method used: none|stealthy|pgd|replacement')
    parser.add_argument('--pgd_eps', type=float, default=5e-2, help='the eps of pgd')
    parser.add_argument('--backdoor_type', type=str, default="none",
                        help='backdoor type used: none|trigger|semantic|edge-case|')
